...
const services = [
  {
    ...
    features: [
      '3–5 minute edited reel',
      'Custom intro with your name & number',
      'Licensed background music',
      'Delivered in HD MP4 format',
      'Permanent shareable link you own forever',
    ],
  ...
  },
  {
    ...
    features: [
      ...
      'Custom motion graphics & title cards',
      'Slow-motion key moments',
      'Multi-angle sequencing',
      'Thumbnail + email-ready format',
      'Two revision rounds',
    ],
  ...
  },
  {
    ...
    features: [
      'Full game film analysis',
      'Coach-ready annotations',
      'PDF + video combo deliverable',
      'Focus on IQ & coachability',
  ...
  },
  {
    ...
    features: [
      'Mobile-optimized personal site',
      'Embedded highlight video',
      'Stats, GPA, grad year',
      'Coach contact form',
      'Permanent shareable URL — yours forever',
    ],
  ...
  },
  {
    ...
    features: [
      '2 sessions/month (1hr each)',
      'School target list creation',
  ...
  },
  {
    ...
    features: [
      'Up to 30 schools/month',
      'Personalized coach emails',
      'Follow-up sequences',
      'Response tracking',
  ...
  },
  {
    ...
    features: [
      'Live showcase with coaches',
      'On-site film capture',
      'Measurables recorded',
      'Certificate of participation',
      'Post-event highlight clip',
    ],
    cta: 'Register Now',
  },
]
                ...
                <div className="card-dark flex flex-col h-full group hover:-translate-y-1">
                  ...
                  <div className="p-8 border-b border-white/5">
                    <div className="flex items-start justify-between mb-4">
                      <div className="text-nlr-gold group-hover:scale-110 transition-transform duration-300">
                        {svc.icon}
                      </div>
                      {svc.badge && (
                    ...
                    <h3 className="font-heading font-bold text-white text-xl tracking-wide uppercase mb-2">
                      {svc.title}
                    </h3>
                  ...
                  <div className="p-8 flex-1 flex flex-col">
                    ...
                    <Link
                      to="/contact"
                      className="btn-gold text-xs py-3 px-6 text-center mt-8 flex items-center justify-center gap-2"
                    >
                      {svc.cta}
