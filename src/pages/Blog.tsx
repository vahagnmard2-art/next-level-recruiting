...
const blogSchema = {
  ...
  description: 'Recruiting tips, NCAA rules explained, and highlight tape strategy for athletes and parents navigating the college recruiting process.',
  url: 'https://next-level-recruiting-theta.vercel.app/blog',
  publisher: {
    '@type': 'Organization',
      ...
      <div className="overflow-x-hidden">
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="inline-flex items-center gap-1 text-nlr-gold font-heading font-bold text-xs tracking-widest uppercase group-hover:text-nlr-gold-light transition-colors">
                        Read
                        <ChevronRight size={10} className="group-hover:translate-x-1 transition-transform" aria-hidden="true" />
                      </span>
                    </div>
                  </Link>
                </AnimatedSection>
        ...
        <section className="py-24 bg-nlr-green" aria-labelledby="blog-cta-heading">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <AnimatedSection>
              <h2 id="blog-cta-heading" className="display-heading text-4xl sm:text-6xl text-white mb-4">
                READY TO BUILD YOUR TAPE?
              </h2>
