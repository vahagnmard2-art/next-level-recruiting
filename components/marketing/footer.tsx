      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div className="lg:col-span-1">
            <Link href="/" className="flex items-center gap-3 mb-6" aria-label="Next Level Recruiting — Home">
          ...
          <nav aria-label="Sports we cover">
            ...
            <ul className="space-y-3 list-none m-0 p-0" role="list">
              {sports.slice(0, 5).map((sport) => (
                <li key={sport}>
                  <Link href="/sports" className="flex items-center gap-2 text-white/50 hover:text-nlr-gold text-sm transition-colors duration-200 group">
                    <ChevronRight size={12} className="group-hover:translate-x-1 transition-transform" aria-hidden="true" />
                    {sport}
                  </Link>
                </li>
          ...
          <div>
            ...
            <address className="not-italic">
              <ul className="space-y-4 list-none m-0 p-0" role="list">
                ...
                <li className="flex items-center gap-3">
                  <InstagramIcon size={16} className="text-nlr-gold flex-shrink-0" />
                  <a href="https://instagram.com/NLRAthletes" target="_blank" rel="noopener noreferrer" className="text-white/50 hover:text-nlr-gold text-sm transition-colors">
                    @NLRAthletes
                  </a>
                </li>
                <li className="flex items-center gap-3">
                  <Phone size={16} className="text-nlr-gold flex-shrink-0" aria-hidden="true" />
                  <a href="tel:+18185217493" className="text-white/50 hover:text-nlr-gold text-sm transition-colors">
                    (818) 521-7493
                  </a>
                </li>
              </ul>
