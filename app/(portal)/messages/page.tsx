  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-white/40 text-sm mt-1">Direct line to Andrew — ask questions, share updates, or get recruiting advice.</p>
      </div>
      ...
      <div className="card-dark overflow-hidden flex flex-col" style={{ height: 'calc(100vh - 280px)', minHeight: '500px' }}>
        <div className="px-6 py-4 border-b border-white/5 flex items-center gap-3">
          ...
          <div>
            <p className="font-heading font-bold text-white text-sm uppercase tracking-wide">Andrew · NLR</p>
            <p className="text-white/40 text-xs">Typically responds same day</p>
          </div>
        </div>
